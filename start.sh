...
echo -e " Enigma Team - Enigma Team - Enigma Team - Enigma Team "
echo -e " Enigma Team - Enigma Team - Enigma Team - Enigma Team "
echo -e " Enigma Team - Enigma Team - Enigma Team - Enigma Team "
echo -e " Enigma Team - Enigma Team - Enigma Team - Enigma Team "
echo -e "                                              \033[0;00m"
echo -e "          Developers @A9369720       "
echo -e "                                               "
echo -e "\e[34m"
...
read VAR
if [ "$VAR" = 1 ]; then
	tmux new-session -s script "bash enigma.sh -t" 
elif [ "$VAR" = 2 ]; then
...
echo -e "\033[38;5;208m"
echo "   1) Run Enigma Bot (tmux)."
echo "   2) Last session (register)."
echo "   3) Last session (tmux)."
echo "   4) Close all sessions."
echo "   5) Re launch Enigma bot (tmux)."
echo "   6) Update Enigma Bot"
echo "   7) Backup Enigma Bot."
echo "   8) Change number."
echo "   9) Restore and Update plugins."
echo "  10) Install Enigma Bot."
echo "  11) Exit."
echo -e "\e[32m"
# options
read VAR
