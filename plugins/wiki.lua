...
local wikiusage = {
  "!wiki [text]: با استفاده از این دستور جست و جو در ویکیپدیا انگلیسی انجام خواهد شد",
  "!wiki(lang) [text]: این دستور حالت کلی تر دستور قبلی برای جست و جو به زبان های مختلف میباشد",
  "!wiki search [text]: Search articles on default Wikipedia (EN)",
  "!wiki(lang) search [text]: \nاز این دستور برای جست و جو استفاده کنید\n Example: !wikies search hola",
}
