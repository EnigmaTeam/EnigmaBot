...
return {
  ...
  usage = {
    "#voting reset: حذف تمامی نتایج",
    "#vote [number]: ثبت نظر",
    "#voting stats: نمایش نتایج"
  },
  patterns = {
    "^[#/!]vot(ing) (reset)",
    "^[#/!]vot(ing) (stats)",
