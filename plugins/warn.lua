...
return {
  usage = {
    "#Warn : \nمشاهده راهنمایی برای اخطار دادن به کاربر",
    "#Warn [on reply] : \nبا این دستور به کاربر مورد نظر اخطار داده میشود",
    "#Unwarn : \nمشاهده راهنمایی برای برداشتن اخطار از کاربر",
    "#Unwarn [on reply] : \nبا این دستور یک اخطار کاربر مورد نظر حذف میشود",
    "این دستور فقط توسط سازنده ربات قابل اجرا میباشد"
    },
  patterns = {
    "^[#!/]([Ww][Aa][Rr][Nn])$",
    "^[#!/]([Ww][Aa][Rr][Nn]) (.*)$",
