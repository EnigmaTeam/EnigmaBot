...
VOLUNTARYCHECK=0
I=1
BOT=enigma-bot  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
echo -e "               \e[01;34m                    by Enigma Team / Enigma                 \e[00;37;40m"
echo ""
cat << EOF
...
echo ""
echo -e "\033[38;5;208m @enigma_team-----enigma_team\033[0;00m"
echo -e "\033[38;5;208m @enigma_team-----enigma_team \033[0;00m"
echo -e "\033[38;5;208m @enigma_team-----enigma_team \033[0;00m"
echo -e "\033[38;5;208m @enigma_team-----enigma_team \033[0;00m"
echo -e "\033[38;5;208m @enigma_team-----enigma_team \033[0;00m"
...
echo ""
echo -e "\033[38;5;208m @enigma    :)      @enigma \033[0;00m"
echo -e "\033[38;5;208m @enigma    :)      @enigma \033[0;00m"
echo -e "\033[38;5;208m @enigma    :)      @enigma \033[0;00m"
echo -e "\033[38;5;208m @enigma    :)      @enigma \033[0;00m"
echo -e "\033[38;5;208m @enigma    :)      @enigma \033[0;00m"
...
while getopts ":tsTSih" opt; do
  case $opt in
	...
	echo -e "\e[1m"
	echo -e ""
	echo "steady.sh bash script v1 CRUEL 2016 enigma" >&2
	echo ""
	echo -e "\e[0m"
